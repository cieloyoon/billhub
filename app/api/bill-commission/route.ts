...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const apiUrl = `http://apis.data.go.kr/9710000/BillInfoService2/getBillCommissionExaminationInfo?bill_id=${billId}&ServiceKey=${serviceKey}`
    ...
    console.log('API 응답 받음:', data.length, '바이트')
